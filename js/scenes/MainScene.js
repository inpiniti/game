// ============================================================
//  RilyBox Game — Main Scene
//  - 광활한 Tiled 맵(map/level1.json)을 카메라가 스크롤
//  - 캐릭터는 항상 화면 중앙, 지형이 움직임
//  - 조작: 화살표 / 왼쪽 조이스틱(이동), Space / 오른쪽 버튼(채집·공격)
// ============================================================

const U = 'assets/Tiny Swords/Tiny Swords (Update 010)';
const F = 'assets/Tiny Swords (Free Pack)/Tiny Swords (Free Pack)';

const GAME_W = 1280;   // 화면(카메라 뷰) 크기 — 맵은 이보다 훨씬 큼
const GAME_H = 720;
